...
class SubpagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subpage" do
    assert_difference('Subpage.count') do
      post subpages_url, params: { subpage: { content: @subpage.content, heading: @subpage.heading, link: @subpage.link, page_id: @subpage.page_id, title: @subpage.title, user_id: @subpage.user_id } }
    end
  ...
  test "should update subpage" do
    patch subpage_url(@subpage), params: { subpage: { content: @subpage.content, heading: @subpage.heading, link: @subpage.link, page_id: @subpage.page_id, title: @subpage.title, user_id: @subpage.user_id } }
