...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { home_id: @style.home_id, name: @style.name, sheet: @style.sheet, style: @style.style } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { home_id: @style.home_id, name: @style.name, sheet: @style.sheet, style: @style.style } }
